  ...
  return (
    <div>
      <h2 id="tag-heading" data-cy="TagHeading">
        <Translate contentKey="inventoryLabApp.tag.home.title">Tags</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="inventoryLabApp.tag.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="inventoryLabApp.tag.home.createLabel">Create new Tag</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tagList && tagList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="inventoryLabApp.tag.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="inventoryLabApp.tag.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="inventoryLabApp.tag.home.notFound">No Tags found</Translate>
            </div>
          )
        )}
      </div>
