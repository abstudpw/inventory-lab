...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rental.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RENTAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_RENTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RENTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RENTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RENTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RENTAL actions', async () => {
      const expectedActions = [
        {
