...
export const ProducerUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="inventoryLabApp.producer.home.createOrEditLabel" data-cy="ProducerCreateUpdateHeading">
            <Translate contentKey="inventoryLabApp.producer.home.createOrEditLabel">Create or edit a Producer</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('inventoryLabApp.producer.name')}
                id="producer-name"
                name="name"
                data-cy="name"
                type="text"
