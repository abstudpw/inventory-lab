...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './eq-tag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQTAG_LIST actions', async () => {
    ...
    it('dispatches FETCH_EQTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EQTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EQTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EQTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EQTAG actions', async () => {
      const expectedActions = [
        {
