...
class ItemResourceIT {
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().rented(DEFAULT_RENTED);
        // Add required entity
        Equipment equipment;
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().rented(UPDATED_RENTED);
        // Add required entity
        Equipment equipment;
        if (TestUtil.findAll(em, Equipment.class).isEmpty()) {
    ...
    void createItem() throws Exception {
        ...
        assertThat(testItem.getRented()).isEqualTo(DEFAULT_RENTED);
    }
    ...
    void putNewItem() throws Exception {
        ...
        updatedItem.rented(UPDATED_RENTED);
        ...
        Item testItem = itemList.get(itemList.size() - 1);
        assertThat(testItem.getRented()).isEqualTo(UPDATED_RENTED);
    }
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.rented(UPDATED_RENTED);
